          ...
          Row(
            children: [
              Padding(
                ...
                child: Text ("LIST OF COURSES", style: new TextStyle(
                      color: Color(0Xff13438f),
                      fontWeight: FontWeight.w600,
                      fontSize: 20,
         ...
         Padding(
          ...
          Card(
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                maxLines: 8,
                decoration: InputDecoration.collapsed(hintText: "Reason Absent",
                hintStyle: TextStyle(fontSize: 14.0, color: Color(0xffd8d8d8))),
              ),
            )
          ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Attach file',style: TextStyle(color: Color(0xff13438f),fontSize: 16)),
              ],
            ),
          ),
